...
//{
//    private Dictionary<string, UpGradeDataTable> dictionoary = new Dictionary<string, UpGradeDataTable>();
...
//        var list = LoadCSV<UpGradeDataTable>(textAsset.text);
...
//    public UpGradeDataTable Get(string key)
//    {
